...
sudo cp -v $SOURCE_DIR/openvas-scanner-$OPENVAS_DAEMON/rust/target/release/openvasd $INSTALL_DIR/openvasd/usr/local/bin/
sudo cp -v $SOURCE_DIR/openvas-scanner-$OPENVAS_DAEMON/rust/target/release/scannerctl $INSTALL_DIR/openvasd/usr/local/bin/
